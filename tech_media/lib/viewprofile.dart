...
class viewprofile extends StatefulWidget {
  final Post post;
  @override
  viewprofileState createState() => viewprofileState(post);
  viewprofile(this.post);
}
                    ...
                    SliverList(
                      ...
                      (context, index) {
                        ...
                        return (post.type == "video")
                            ? postvideodesign(post, "Random")
                            : postdesign(post, "Random");
                      },
