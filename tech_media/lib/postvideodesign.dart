...
class postvideodesign extends StatefulWidget {
  @override
  _postvideodesignState createState() => _postvideodesignState(post, from);
  final Post post;
  final String from;
  postvideodesign(this.post, this.from);
}
...
// ignore: camel_case_types
class _postvideodesignState extends State<postvideodesign> {
  final Post post;
  final String from;
  VideoPlayerController controller;
  _postvideodesignState(this.post, this.from);
  @override
  void initState() {
